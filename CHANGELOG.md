...
- PawnIO dependency
- Additional logging
- Use the first available sensor of the correct type if no sensor from LibreHardwareMonitorLib matches by name
- Periodically rescan LibreHardwareMonitorLib sensors after startup

### Changed

- Updated LibreHardwareMonitorLib to v0.9.5
- Updated MoBro SDK to v1.1.0
- Refactored and improved HardwareMonitor class
